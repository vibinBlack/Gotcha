...
def caal(in_t,brk1,brk2,ot_t):
    ...
    if meet > max1 and meet > max2:
        ...
        brk2 = brk2 + meet        #Only possible to schedule meet in Afternoon
    elif meet <= max1 and meet > max2:
        sch.append(in_t)
        sch.append(in_t+meet)  
        in_t = in_t + meet       #Only posssible to schedule meet in Morning
    else:
        sch.append(in_t)
        sch.append(in_t+meet) 
        in_t = in_t+meet     #possible to schedule meet at any time.
    print(sch)
...
while urcal:
    ...
    if count == 0:
        ...
        Final, in_t, brk2 = caal(in_t,brk1,brk2,ot_t)
